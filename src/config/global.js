export default {
  ...
  complementario: [
    {
      texto:
        'UXTips. (2018). ¿Qué es Arquitectura de la Información? [Video]. YouTube.',
      tipo: 'Video',
      link: 'https://www.youtube.com/watch?v=twVvK1eYmig',
    },
    {
      texto:
        'yReyALD. (2020). BALSAMIQ MOCKUPS / Instalación y maquetación de una aplicación móvil - FACIL (música GOT de fondo) [Video]. YouTube.',
      tipo: 'Video',
      link: 'https://www.youtube.com/watch?v=idX3aFx67Vc',
    },
    {
      texto:
        'Bluuweb! (2018). Materialize CSS Material Design Framework [Curso tutorial Español] [Video]. YouTube.',
      tipo: 'Video',
